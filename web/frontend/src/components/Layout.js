...
const Layout=()=>{
 ...
 return <div className="min-h-screen bg-white text-slate-950 lg:flex">
  <aside className="flex border-b border-slate-200 bg-white shadow-sm lg:sticky lg:top-0 lg:h-screen lg:w-72 lg:flex-col lg:border-b-0 lg:border-r">
   <div className="flex min-w-0 items-center gap-3 p-4 lg:block lg:p-6"><NavLink to="/dashboard" className="flex items-center gap-3"><img src={logo} alt="X2DHF" className="h-11 w-11 rounded-lg border border-slate-200 shadow-sm lg:h-12 lg:w-12"/><div><h1 className="text-xl font-black tracking-wide text-slate-950 lg:text-2xl">X2DHF</h1><p className="hidden text-xs text-slate-500 sm:block">Native HF and DFT SaaS</p></div></NavLink><div className="ml-auto hidden rounded-lg border border-emerald-200 bg-emerald-50 px-3 py-2 text-xs text-emerald-900 lg:ml-0 lg:mt-5 lg:block lg:px-4 lg:py-3"><div className="font-mono uppercase tracking-[.24em] text-emerald-700">Runtime</div><div className="mt-1 font-semibold">Native X2DHF engine</div></div></div>
