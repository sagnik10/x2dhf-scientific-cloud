...
const blocks=[
 ...
 {title:'Density Functional Theory',body:'DFT replaces the full many-electron wavefunction with density-driven exchange-correlation terms. The functional selector is preserved in the input deck and used by the native Libxc-enabled X2DHF build.'},
 ...
 {title:'Output Format',body:'Web jobs store the original X2DHF listing from stdout, including the native banner, echoed input, SCF table, energy components, orbital table, and CPU summary.'}
];
