...
urlpatterns+=[path('favicon.png',ReactAssetView.as_view(),{'path':'favicon.png'}),re_path(r'^(?P<path>static/media/.*)$',ReactAssetView.as_view()),re_path(r'^(?!api/|admin/|media/|static/).*$' ,ReactAppView.as_view(),name='react-app')]
if settings.DEBUG:
